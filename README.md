...
<!-- ===================== -->
<p align="center">
  <img src="./assets/banner-cyber.png" alt="lostsig banner"/>
</p>
...
Oie! Pode me chamar de **Pazzini**.

🧠 Sou estudante de **Ciência da Computação** & **Segurança Cibernética**, explorando sistemas, superfícies de ataque e comportamentos invisíveis da web.

👁️ Prefiro observar antes de agir.  
🧩 Código, falhas e padrões falam mais alto do que discursos.
...
### 💻 Dev & Security Stack
<p align="left">
  <img src="https://skillicons.dev/icons?i=js,python,linux,azure,bash,docker,prisma" />
</p>

### 🔐 Cyber / Segurança (em evolução)
